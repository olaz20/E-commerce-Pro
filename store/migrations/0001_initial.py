# Generated by Django 5.1.2 on 2024-12-16 14:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('seller', 'Seller'), ('buyer', 'Buyer'), ('admin', 'Admin')], default='buyer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_government', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.localgovernment')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.CharField(choices=[('flutterwave', 'Flutterwave'), ('pay_on_delivery', 'Pay on Delivery')], default='pay_on_delivery', max_length=100)),
                ...
                ('shipping_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.address')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('expires_at', models.DateTimeField(verbose_name=datetime.timedelta(seconds=900))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status', models.CharField(choices=[('pending', 'Pending'), ('processing', 'Processing'), ('delivered', 'Delivered')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lga', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='shipping_fee', to='store.localgovernment')),
            ],
        ),
        migrations.CreateModel(
            name='State',
        ...
        migrations.AddField(
            ...
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='local_governments', to='store.state'),
        ),
        migrations.AddField(
            model_name='address',
            name='state',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'auth_code'), name='unique_user_otp'),
        ),
    ]
