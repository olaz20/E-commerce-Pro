...
from .views import (CartItemViewSet, CartViewSet, OrderViewSet, AddressFormView,
    CountryListView,
    StateListView,
    LGAListView,
    ShippingFeeView)
...
urlpatterns = [
    ...
    path('shipping-fees/<int:lga_id>/', ShippingFeeView.as_view(), name='shipping-fee-list'),
]
